...
{
  // Node setup
  ros::init(argc, argv, "ax2550_node_rear");
  ros::NodeHandle n;
  ...
  // Encoder Publisher
  encoder_pub = n.advertise<ax2550::StampedEncoders>("/omnimaxbot/rear/encoders", 5);
  
  // cmd_vel Subscriber
  ros::Subscriber sub = n.subscribe("/omnimaxbot/rear/cmd_vel", 1, cmd_velCallback);
